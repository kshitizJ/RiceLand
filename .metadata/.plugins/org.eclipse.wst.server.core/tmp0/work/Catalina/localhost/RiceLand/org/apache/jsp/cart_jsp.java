 ...
 * Generated at: 2021-05-03 05:11:36 UTC
...
if (user1 == null) {
	response.sendRedirect("login.jsp");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tsrc=\"./assets/images/rice/basmati (3).jpeg\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>Bamati Rice by Kohinoor</p>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<small>Price: Rs.170/Kg</small> <br> <a href=\"\"><b>Remove</b></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><i class=\"fas fa-chevron-up\" data-id=");
      ...
      out.write("></i>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"item-amount\">1</p> <i class=\"fas fa-chevron-down\"\n");
      out.write("\t\t\t\t\t\t\t\t\tdata-id=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${item.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("></i></td>\n");
      out.write("\t\t\t\t\t\t\t\t<td>Rs.170</td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cart-info\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img style=\"border-radius: 5px;\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tsrc=\"./assets/images/rice/brown%20(3).jpeg\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>Brown Rice</p>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<small>Price: Rs.110/Kg</small> <br> <a href=\"\"><b>Remove</b></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><i class=\"fas fa-chevron-up\" data-id=");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"cart-info\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img style=\"border-radius: 5px;\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tsrc=\"./assets/images/rice/black%20(2).jpg\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>Black Rice</p>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<small>Price: Rs.325/Kg</small> <br> <a href=\"\"><b>Remove</b></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t\t\t\t<td><i class=\"fas fa-chevron-up\" data-id=");
      ...
      out.write("\t\t\t\t\t\t\t\t<td>RS.640</td>\n");
      out.write("\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t</table>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"col-12 text-center\">\n");
      out.write("\t\t\t\t\t<button type=\"submit\" class=\"btn\">Checkout</button>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      out.write("\t</section>\n");
