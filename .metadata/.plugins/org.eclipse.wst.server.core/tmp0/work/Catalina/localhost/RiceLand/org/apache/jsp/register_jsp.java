 ...
 * Generated at: 2021-05-24 07:30:24 UTC
...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</nav>");
      out.write("\n");
      out.write("\t<header class=\"register-page\">\n");
      out.write("\t\t<div\n");
      out.write("\t\t\tclass=\"container d-flex justify-content-center align-items-center\">\n");
      out.write("\t\t\t<div class=\"row\">\n");
      out.write("\t\t\t\t<div class=\"col-lg-6 col-12\">\n");
      out.write("\t\t\t\t\t<img src=\"./assets/images/rice/mainn-rice.jpg\" width=100%>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div\n");
      out.write("\t\t\t\t\tclass=\"col-lg-6 col-12 d-flex justify-content-center align-items-center\">\n");
      out.write("\t\t\t\t\t<form onsubmit=\"return validation()\" class=\"needs-validation\"\n");
      out.write("\t\t\t\t\t\tnovalidate method=\"post\" action=\"UserServlet\">\n");
      out.write("\t\t\t\t\t\t<div class=\"form-row\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group col-md-6 mb-3\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"fname\">First name</label> <input type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"fname\" name=\"fname\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"lname\" name=\"lname\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"Email ID\" name=\"email\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\taria-describedby=\"inputGroupPrepend\" required>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"invalid-feedback\">Please enter your email\n");
      out.write("\t\t\t\t\t\t\t\t\t\taddress.</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group col-md-6\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"pass\">Password</label> <input type=\"password\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"pass\" name=\"pass\"\n");
      out.write("\t\t\t\t\t\t\t\t\tplaceholder=\"Password\" required>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"invalid-feedback\">Please enter password.</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group col-md-6\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"number\">Mobile Number</label> <input type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"number\" name=\"number\"\n");
      out.write("\t\t\t\t\t\t\t\t\tplaceholder=\"Mobile Number\" required>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"invalid-feedback\">Please enter mobile number.</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group col-md-6\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"cpass\">Confirm Password</label> <input\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"password\" class=\"form-control\" id=\"cpass\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\tplaceholder=\"Apartment, studio, or floor\" required>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"city\" name=\"city\" placeholder=\"City\"\n");
      out.write("\t\t\t\t\t\t\t\t\trequired>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"invalid-feedback\">Please provide a valid city.\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group col-md-3\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"zip\">Zip</label> <input type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"zip\" name=\"zip\" placeholder=\"Zip\"\n");
      out.write("\t\t\t\t\t\t\t\t\trequired>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"invalid-feedback\">Please provide a valid zip.\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-check\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"form-check-input\" type=\"checkbox\" value=\"\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"tandc\" required> <label class=\"form-check-label\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\tfor=\"tandc\"> Agree to terms and conditions </label>\n");
      ...
      out.write("\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t<button type=\"submit\" class=\"col-12 btn btn-primary\">Sign\n");
      out.write("\t\t\t\t\t\t\tIn</button>\n");
      out.write("\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\tif (cpass == \"\") {\n");
      out.write("\t\t\tdocument.getElementById(\"check\").innerHTML = \"Please confirm your password.\";\n");
      out.write("\t\t\treturn false;\n");
      out.write("\t\t} else {\n");
      out.write("\t\t\tdocument.getElementById(\"check\").innerHTML = \"\";\n");
      out.write("\t\t}\n");
      out.write("\t\tif (cpass != pass) {\n");
      out.write("\t\t\tdocument.getElementById(\"check\").innerHTML = \"Both passwords should match.\";\n");
      out.write("\t\t\treturn false;\n");
      out.write("\t\t} else {\n");
      out.write("\t\t\tdocument.getElementById(\"check\").innerHTML = \"\";\n");
      out.write("\t\t}\n");
