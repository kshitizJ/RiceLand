 ...
 * Generated at: 2021-05-12 04:52:37 UTC
...
response.sendRedirect("../login.jsp");
	...
	List<Order> orders = orderDao.getOrder(Integer.parseInt(request.getParameter("id")));
      ...
      out.write("\t\t\t\t<h1 class=\"text-center\">User Order</h1>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t<div class=\"alert alert-success\" role=\"alert\">Order\n");
      out.write("\t\t\t\t\tCompleted..</div>\n");
      out.write("\t\t\t\t");
      ...
      out.write("/-</td>\n");
      out.write("\t\t\t\t\t\t\t<td><a\n");
      out.write("\t\t\t\t\t\t\t\thref=\"../CompletedOrder?id=");
      out.print(order.getOid());
      out.write("&uid=");
      out.print(request.getParameter("id"));
      out.write("\"\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"btn btn-success\">Completed</a></td>\n");
      out.write("\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t");
