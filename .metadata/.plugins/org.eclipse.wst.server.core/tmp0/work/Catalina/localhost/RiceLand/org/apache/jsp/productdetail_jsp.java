 ...
 * Generated at: 2021-05-03 06:27:25 UTC
...
if (user1 == null) {
	response.sendRedirect("login.jsp");
      ...
      out.write("</nav>");
      out.write("\n");
      out.write("\t<!------- single product details ------->\n");
      out.write("\t<section id=\"productDetail\">\n");
      out.write("\t\t<div class=\"container\">\n");
      ...
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"col-md-5 col-12 text-center\">\n");
      out.write("\t\t\t\t\t<p class=\"breadcrumb\">\n");
      out.write("\t\t\t\t\t\t<a href=\"./index.jsp\">Home</a>/<a href=\"./products.jsp\">Products</a>/Details\n");
      out.write("\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t<h1>Basmati Rice</h1>\n");
      out.write("\t\t\t\t\t<h4>Rs.170/kg</h4>\n");
      ...
      out.write("\t\t\t\t\t<h3>\n");
      out.write("\t\t\t\t\t\t<i class=\"fa fa-indent\"></i> Product Details\n");
      out.write("\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\tGive your tastebud a flavour of basmati rice by Kohinoor.<br>It\n");
      out.write("\t\t\t\t\t\tis non-sticky and posses 100% purity and have aromatic fragrance\n");
      out.write("\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"col-12 cment\">\n");
      out.write("\t\t\t\t\t<h2 class=\"text-center cment-title\">Comments</h2>\n");
      out.write("\t\t\t\t\t<div class=\"comments\">\n");
      out.write("\t\t\t\t\t\t<div class=\"comment\" id=\"0\">\n");
      out.write("\t\t\t\t\t\t\t<h5>\n");
      out.write("\t\t\t\t\t\t\t\t<b>Gagan Chaturvedi</b> <i class=\"fa fa-star\"></i> <i\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"fa fa-star\"></i> <i class=\"fa fa-star\"></i> <i\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"fa fa-star\"></i>\n");
      out.write("\t\t\t\t\t\t\t</h5>\n");
      out.write("\t\t\t\t\t\t\t<p>Amazing quality. Buying it quite regularly. Cost effective\n");
      out.write("\t\t\t\t\t\t\t\ttoo.</p>\n");
      out.write("\t\t\t\t\t\t\t<hr>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"comment\" id=\"1\">\n");
      out.write("\t\t\t\t\t\t\t<h5>\n");
      out.write("\t\t\t\t\t\t\t\t<b>Sandesh Bhagat</b> <i class=\"fa fa-star\"></i> <i\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"fa fa-star\"></i> <i class=\"fa fa-star\"></i> <i\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"fa fa-star\"></i> <i class=\"fa fa-star\"></i>\n");
      out.write("\t\t\t\t\t\t\t</h5>\n");
      out.write("\t\t\t\t\t\t\t<p>This one has longest grain I have seen after cooking. I\n");
      out.write("\t\t\t\t\t\t\t\thave tried many, now I have settled to this one.</p>\n");
      out.write("\t\t\t\t\t\t\t<hr>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"comment\" id=\"3\">\n");
      out.write("\t\t\t\t\t\t\t<h5>\n");
      out.write("\t\t\t\t\t\t\t\t<b>Rohan Nanda</b> <i class=\"fa fa-star\"></i> <i\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"fa fa-star\"></i> <i class=\"fa fa-star\"></i>\n");
      out.write("\t\t\t\t\t\t\t</h5>\n");
      out.write("\t\t\t\t\t\t\t<p>All the products were good and impressive. Keep it up and\n");
      out.write("\t\t\t\t\t\t\t\tI am satisfied with this purchase.</p>\n");
      out.write("\t\t\t\t\t\t\t<hr>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<form action=\"\">\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t<label for=\"review\">Your Comment</label>\n");
      out.write("\t\t\t\t\t\t\t<textarea class=\"form-control\" id=\"review\" name=\"review\" rows=\"3\"></textarea>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"input-group mb-3 col-md-3 col-10\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"input-group-prepend\">\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"input-group-text\" for=\"star\">Star</label>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<select class=\"custom-select\" id=\"star\" name=\"star\">\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\" selected>5</option>\n");
