 ...
 * Generated at: 2021-05-05 12:22:30 UTC
...
public final class productdetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.detail.Review");
...
if (user1 != null) {
	...
	List<Review> reviews = reviewdao.getReview(id);
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t<div class=\"comment\" id=\"");
      out.print(r.getR_id());
      out.write("\">\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<form action=\"ReviewSevrlet\" method=\"post\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<label class=\"input-group-text\" for=\"rating\">Rating</label>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<select class=\"custom-select\" id=\"rating\" name=\"rating\">\n");
