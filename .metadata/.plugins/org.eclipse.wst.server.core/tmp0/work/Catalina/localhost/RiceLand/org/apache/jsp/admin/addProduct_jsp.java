 ...
 * Generated at: 2021-05-04 14:28:32 UTC
...
public final class addProduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/admin/adminNav.jsp", Long.valueOf(1620131478802L));
...
if (admin != null) {
      ...
      out.write("\t\t\t<li class=\"nav-item\"><a class=\"nav-link\" href=\"showUsers.jsp\">Users</a></li>\n");
      out.write("\t\t\t<li class=\"nav-item\"><a class=\"nav-link\" href=\"showProduct.jsp\">Products</a></li>\n");
      out.write("\t\t\t<li class=\"nav-item\"><a class=\"nav-link\" href=\"addProduct.jsp\">Add\n");
      out.write("\t\t\t\t\tProduct</a></li>\n");
      out.write("\t\t</ul>\n");
      out.write("\t\t<div class=\"d-flex ml-auto\">\n");
      out.write("\t\t\t<a class=\"nav-link btn btn-success mx-2\" href=\"\">");
      out.print(admin.getFname() + " " + admin.getLname());
      out.write("</a>\n");
      out.write("\t\t\t<a class=\"nav-link btn btn-danger\" href=\"../LogoutServlet\">Logout</a>\n");
      out.write("\t\t</div>\n");
      out.write("\t</div>\n");
      out.write("</nav>\n");
...
response.sendRedirect("../login.jsp");
      ...
      out.write("\t\t\t\t<h1 class=\"text-center\">Add Product</h1>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t<div class=\"alert alert-danger\" role=\"alert\">Failed to add the\n");
      out.write("\t\t\t\t\tproduct, please try again...</div>\n");
      out.write("\t\t\t\t");
      ...
      out.write("\n");
      out.write("\t\t\t\t<div class=\"alert alert-success\" role=\"alert\">Successfully\n");
      out.write("\t\t\t\t\tadded the product...</div>\n");
      out.write("\t\t\t\t");
      ...
      out.write("\n");
      out.write("\t\t\t\t<form class=\"row\" action=\"../ProductServlet\" method=\"post\">\n");
      ...
      out.write("\t\t\t\t\t\t\tplaceholder=\"Product Name\" name=\"name\" required>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-md-6 mb-3\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\tid=\"customFile\" name=\"img\" required>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-md-6 mb-3\">\n");
      out.write("\t\t\t\t\t\t<label for=\"validationCustom01\">Price</label> <input type=\"number\"\n");
      out.write("\t\t\t\t\t\t\tclass=\"form-control\" id=\"validationCustom01\"\n");
      out.write("\t\t\t\t\t\t\tplaceholder=\"Product Price\" min=\"0\" name=\"price\" required>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-md-6 mb-3\">\n");
      out.write("\t\t\t\t\t\t<label class=\"form-label\" for=\"star\">Star</label> <select\n");
      out.write("\t\t\t\t\t\t\tclass=\"custom-select\" id=\"star\" name=\"star\" disabled=\"disabled\">\n");
      out.write("\t\t\t\t\t\t\t<option value=\"0\" selected>0</option>\n");
      out.write("\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-md-6 mb-3\">\n");
      out.write("\t\t\t\t\t\t<label for=\"review\">Description</label>\n");
      out.write("\t\t\t\t\t\t<textarea class=\"form-control\" id=\"review\" name=\"description\"\n");
      out.write("\t\t\t\t\t\t\trows=\"1\" placeholder=\"Description\" required></textarea>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-md-6 mb-3\">\n");
